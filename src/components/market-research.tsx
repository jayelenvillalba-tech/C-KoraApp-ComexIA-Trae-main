...
export default function MarketResearch() {
  ...
  const hsProducts = [
    ...
    { value: "0901", label: "CafÃ© (0901)" },
    { value: "1001", label: "Trigo (1001)" },
    { value: "1005", label: "MaÃ­z (1005)" },
    { value: "8471", label: "MÃ¡quinas de procesamiento de datos (8471)" },
    { value: "8703", label: "AutomÃ³viles (8703)" },
  ];
      ...
      requiredDocuments: [
          {
            ...
            description: "Certifica que la carne proviene de animales sanos, con inspecciÃ³n ante/post mortem.",
            requirements: "Establecimiento autorizado, VacunaciÃ³n, Trazabilidad completa.",
            link: "https://www.argentina.gob.ar/senasa"
          },
          {
             name: "FSIS Form 9060-5",
             issuer: "USDA / FSIS (EE.UU.)",
             description: "Certificado de Salubridad de ExportaciÃ³n de Carnes y Aves.",
             requirements: "Requiere inspecciÃ³n oficial en puerto de entrada.",
             link: "https://www.fsis.usda.gov/"
          },
          {
             name: "Etiquetado Aprobado (Label Approval)",
             issuer: "USDA / FSIS",
             description: "AprobaciÃ³n de etiquetas genÃ©ricas o especÃ­ficas.",
             requirements: "Incluir paÃ­s de origen, establecimiento, peso neto.",
             link: "https://www.fsis.usda.gov/"
          }
      ]
  };
  ...
  const getRadarData = (country: CountryOpportunity) => [
    ...
    { subject: 'LogÃ­stica', A: parseFloat(country.logisticsScore || "0"), fullMark: 100 },
    ...
    <div className="glass-card rounded-2xl p-6 mb-8">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-xl font-bold text-gray-900 flex items-center">
          ...
          AnÃ¡lisis de Mercados Globales
        </h3>
        {viewMode === "details" && (
      ...
      {viewMode === "ranking" ? (
        ...
        >
          <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
            ...
            Ranking de PaÃ­ses por Oportunidad
          </h4>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="hidden md:grid grid-cols-4 gap-2 text-center">
                      ...
                      <div className="text-xs">
                        ...
                        <span className="text-gray-500 mt-1 block">LogÃ­stica</span>
                      </div>
                      <div className="text-xs">
        ...
        selectedCountry && (
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h4 className="text-2xl font-bold text-gray-900 mb-2 flex items-center">
                  ...
                  AnÃ¡lisis Detallado: {selectedCountry.countryName}
                </h4>
                <div className={`inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium ${getScoreColor(selectedCountry.opportunityScore || "0")}`}>
                  ...
                  PuntuaciÃ³n de Oportunidad: {selectedCountry.opportunityScore}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="mt-4 grid grid-cols-3 gap-4 text-center">
                  <div className="p-3 bg-blue-50 rounded-lg">
                    <div className="text-xs text-blue-600 font-medium uppercase">TamaÃ±o</div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="mt-4 text-center text-sm text-gray-500">
                  EvaluaciÃ³n integral basada en 5 factores clave
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600 text-sm">Complejidad LogÃ­stica</span>
                  ...
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    <span className="text-gray-600 text-sm">PuntuaciÃ³n LogÃ­stica</span>
              ...
              {/* Mostrar documentaciÃ³n para cualquier producto si hay requisitos */}
              {(requirements || (selectedCountry && hsCode === '0201')) && (() => {
                const activeRequirements = (requirements || US_BEEF_MOCK) as any;
                return (
                  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm lg:col-span-2">
                    <div className="flex items-center justify-between mb-6">
                      <h5 className="font-semibold text-gray-900 flex items-center">
                        <Package className="mr-2 w-5 h-5 text-purple-600" />
                        {t('requirements_export', 'Requisitos de ExportaciÃ³n')}
                      </h5>
                      <div className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-xs font-bold">
                        {activeRequirements.hsCode} â†’ {activeRequirements.countryCode}
                      </div>
                    </div>
                    <div className="space-y-2">
                      {activeRequirements.requiredDocuments?.map((doc: any, i: number) => (
                        <div key={i} className="bg-gray-50 p-3 rounded border border-gray-100 text-sm text-gray-700">
                          {typeof doc === 'string' ? doc : (
                            <div>
                              ...
                              {doc.issuer && <span className="ml-2 text-xs text-blue-600">({doc.issuer})</span>}
                              {doc.description && <p className="mt-1 text-gray-600">{doc.description}</p>}
                            </div>
                          )}
                        </div>
                      ))}
