...
export default function Home() {
  ...
  const quickAccesItems = [
    ...
    { icon: <Ship className="w-5 h-5 text-blue-400" />, label: 'Log├¡stica', path: '/analysis?tab=calculator', color: 'bg-blue-500/10 border-blue-500/20' },
          ...
          <section className="relative min-h-[500px] flex flex-col items-center justify-center text-center p-8" data-aos="fade-up">
            ...
            <div className="relative z-10 max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-gray-200 text-xl max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium">
                Desde la clasificaci├│n arancelaria hasta el c├ílculo log├¡stico puerta a puerta. 
              ...
              <div className="max-w-3xl mx-auto w-full mt-10" data-aos="fade-up" data-aos-delay="200">
                {/* Contenedor del buscador con glass m├ís suave */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="glass-premium rounded-2xl p-6 border border-white/5 h-full">
                ...
                <div className="space-y-4">
                  <div className="p-4 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors cursor-pointer">
                    ...
                    <p className="text-sm text-gray-300 font-medium">Nuevas sanciones a exportaci├│n de tecnolog├¡a dual-use a Rusia.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors cursor-pointer">
                    <div className="flex justify-between items-start mb-2">
                    ...
                    <p className="text-sm text-gray-300 font-medium">Congesti├│n portuaria en Shanghai aumenta tiempos de tr├ínsito (+7 d├¡as).</p>
                  </div>
            ...
            <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6" data-aos="fade-up" data-aos-delay="600">
              <FeatureCard 
                ...
                title="Calculadora Log├¡stica"
                description="Costos puerta a puerta con impuestos y servicios incluidos."
                detailedDescription="Simula operaciones de expo/impo mar├¡timas, a├®reas y terrestres con precisi├│n milim├®trica."
                actionLabel="Simular"
              ...
              <FeatureCard 
                ...
                description="Generaci├│n autom├ítica de documentos regulatorios."
              ...
              <FeatureCard 
                ...
                detailedDescription="Descubre nuevos mercados con an├ílisis predictivo de demanda y competencia."
              ...
              <FeatureCard 
                ...
                detailedDescription="Directorio verificado de proveedores de servicios log├¡sticos y legales."
